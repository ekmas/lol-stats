                ...
                {team1.map(player => {
                    return(
                        <div className='flex items-center'>
                            <img className='w-[14px] h-[14px] mr-1' key={crypto.randomUUID()} src={`http://ddragon.leagueoflegends.com/cdn/13.8.1/img/champion/${player.championName}.png`} alt="champion" />
