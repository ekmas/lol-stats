...
export default function Modal({ message, setMessage }) {
  return (
    <div className={message !== '' ? 'fixed w-full h-full left-0 top-0 flex bg-transparent items-center backdrop-blur-sm justify-center visible' : 'invisible fixed w-full h-full left-0 top-0 flex bg-transparent items-center justify-center'}>
